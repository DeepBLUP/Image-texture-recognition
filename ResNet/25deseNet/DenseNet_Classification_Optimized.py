...
class ModifiedDenseNet(nn.Module):
    def __init__(self, num_classes=5):
        ...
        # 加载预训练的DenseNet模型，使用weights参数替代deprecated的pretrained
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if val_f1 > best_val_f1:
            best_val_f1 = val_f1
            patience_counter = 0
            torch.save(model.state_dict(), r'/home/chuannong1/ZLY/2024/IMF/大理石纹等级/deseNet/best_model906-deseNet-classification.pth')
        else:
            patience_counter += 1
    ...
    # 测试模型
    model.load_state_dict(torch.load(r'/home/chuannong1/ZLY/2024/IMF/大理石纹等级/deseNet/best_model906-deseNet-classification.pth'))
    ...
    df.to_csv('/home/chuannong1/ZLY/2024/IMF/大理石纹等级/deseNet/test_metrics-deseNet-classification.csv', index=False)
    
    # 保存混淆矩阵
    cm_df = pd.DataFrame(cm)
    cm_df.to_csv('/home/chuannong1/ZLY/2024/IMF/大理石纹等级/deseNet/confusion_matrix-deseNet-classification.csv', index=False)
