...
def main():
    ...
    # 使用ResNet50模型
    model = ModifiedResNet50(CBAMBottleneck, [3, 4, 6, 3])
    ...
    for epoch in range(num_epochs):
        ...
        if val_pcc > best_val_pcc:
            ...
            torch.save(model.state_dict(), '/home/chuannong1/ZLY/2024/IMF/大理石纹等级/ResNet/best_model906-CBAM.pth')
    ...
    # 测试模型
    model.load_state_dict(torch.load('/home/chuannong1/ZLY/2024/IMF/大理石纹等级/ResNet/best_model906-CBAM.pth'))
    model.eval()
    test_loss = 0.0
    test_labels = []
    test_preds = []
    ...
    # 保存DataFrame到CSV文件
    df.to_csv('/home/chuannong1/ZLY/2024/IMF/大理石纹等级/ResNet/test_metrics906CBAM.csv', index=False)
